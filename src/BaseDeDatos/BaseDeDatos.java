...
public class BaseDeDatos {
	...
	public static void main(String args[]) {
		...
		String sql = "INSERT INTO `agenda`.`contacto` (`Nombre`, `Apellido`, `Telefono`, `Fecha_de_nacimiento`, `Vinculo`, `Imagen`, `Id`) VALUES ('Brian', 'lvl', '123456', '0000-02-11', 'amigo', '100101', 2);";
